...
final class SearchUserCellNode: ASCellNode {
  ...
  private lazy var photoNodes: ASImageNode = {
  ...
  private lazy var userNameNode: ASTextNode = {
    ...
    node.attributedText = "userNameNode".styled(with: Const.userNameStingStyle)
    return node
  }()
  ...
  private lazy var descriptionNode: ASTextNode = {
    ...
    node.attributedText = "descriptionNode".styled(with: Const.descriptionStringStyle)
    return node
  }()
